# Public: Imports the LiquidCarbonTransparentInverse colorscheme
#
# Usage:
#
#   include iterm2::colors::liquidcarbontransparentinverse
#
class iterm2::colors::liquidcarbontransparentinverse(
  $ansi_0_color = [
    0.7362077236175537,
    0.7984277009963989,
    0.8026452660560608
  ...
  iterm2::colors { 'LiquidCarbonTransparentInverse':
